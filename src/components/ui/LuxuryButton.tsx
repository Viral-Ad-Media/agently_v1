...
export const LuxuryButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, ...props }, ref) => {
    const variants = {
      primary: 'bg-ink-950 text-white hover:bg-ink-900 shadow-lg shadow-ink-950/20 active:scale-[0.98]',
      secondary: 'bg-white text-ink-900 border border-slate-200 hover:border-slate-300 hover:bg-slate-50 shadow-sm active:scale-[0.98]',
      tertiary: 'bg-transparent text-slate-lux hover:bg-slate-100 active:scale-[0.98]',
      destructive: 'bg-red-50 text-red-600 border border-red-100 hover:bg-red-100 active:scale-[0.98]',
